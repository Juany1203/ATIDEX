...
namespace Atidex
{
    public partial class InterfazDelVisitante : Form
    {
        private IconButton currentBtn;
        private Panel leftBorderBtn;
        private Form currentChildForm;
        public InterfazDelVisitante()
        {
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm (new FormVisitanteEntrenadores());
        ...
        {
            ActiveButton(sender, Color.FromArgb(200, 120, 0));
            OpenChildForm(new FormVisitanteMovimientos());
        }

        private void iconButton4_Click(object sender, EventArgs e)
        {
            ActiveButton(sender, Color.FromArgb(200, 120, 0));
            OpenChildForm(new FormVisitantePokemones());
        }
